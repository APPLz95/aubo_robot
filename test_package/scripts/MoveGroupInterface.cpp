...
int main(int argc, char** argv)
{
  ...
  visual_tools.publishText(text_pose, "AUBO Command", rvt::RED, rvt::XLARGE);
  ...
  visual_tools.prompt("Press 'next'1 in the RvizVisualToolsGui window to move to zero");
  ...
  std::vector<double> j_position;
  j_position.push_back(0.0);
  j_position.push_back(0.0);
  j_position.push_back(0.0);
  j_position.push_back(0.0);
  j_position.push_back(0.0);
  j_position.push_back(1.5708);
  move_group.setJointValueTarget(j_position);
  move_group.move();
  ...
  joint_group_positions[1] = -0.12726438251;  // radians
  joint_group_positions[2] = -1.32112050212;  // radians
  joint_group_positions[3] = 0.376933906537;  // radians
